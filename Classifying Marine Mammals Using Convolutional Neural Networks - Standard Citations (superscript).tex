...
\begin{table}
  ...
  \centering
    \begin{tabular}{l c c c}
      ...
      MAP@5 & 0.886 ± 0.4 & [0.883, 0.889] & 0.881--0.892 \\ \hline
    \end{tabular}
  }
\end{table}
...
\hline
Factor & ResNet + ArcMargin & EffNetB5 + ArcFace \\ \hline
...
Data Resolution and Crops & Single 224 × 224 center crop & Multi-crop pipeline (full-body, detector and ViT crops) \\
Imbalance Mitigation & None & Class-balanced weights \\ \hline
\end{tabular}
}
